...
export default class CosmereUnofficialActorBase extends CosmereUnofficialDataModel {
	...
	static migrateData(source) {
		...
		if (source.expertise && !Array.isArray(source.expertise)) {
			let expertises = [];
		...
		if (source.movement && (
			!source.movement.ground
			|| !isNumeric(source.movement.ground)
			|| isNaN(source.movement.ground)
		)) {
			source.movement.ground = 20;
		}
